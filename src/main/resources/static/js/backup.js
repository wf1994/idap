...
$(document).ready(function () {
    var initChart = echarts.init(document.getElementById("main"));
    draw_circle();
})
...
function show_force_table(name) {
    ...
    $("table").remove();
    $.getJSON('force.json', function (data) {
...
function draw_circle() {
    ...
    $("#main").html(
        "<img src='pic/bg.png' style='width:630px;height:630px;margin-left: 30px'  ></body>\n" +
        "<div id=\"drawing\">\n" +
